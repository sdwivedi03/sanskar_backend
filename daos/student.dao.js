 ...
 * Student's CRUD
 */
 studentDao.get('/:id',async (req,res) => {
...
studentDao.put('/:id',async (req,res) => {
 ...
 * Parents's CRUD
 */
studentDao.get('/:id/parents',async (req,res) => {
...
studentDao.post('/:id/parents',async (req,res) => {
...
studentDao.put('/:id/parents',async (req,res) => {
    // req.body.studentId = req.params.id;
 ...
 * Address's CRUD
 */
studentDao.get('/:id/address',async (req,res) => {
...
studentDao.post('/:id/address',async (req,res) => {
    let params = req.body;
...
studentDao.put('/:id/address',async (req,res) => {
    let params = req.body;
    params[1].studentId = params[0].studentId = req.params.id;
    console.log("aaadddreess1",params);
 ...
 */
 studentDao.get('/:id/fee-detail',async (req,res) => {
...
studentDao.post('/:id/fee-deposit',async (req,res) => {
    req.body.studentId = req.params.id;
